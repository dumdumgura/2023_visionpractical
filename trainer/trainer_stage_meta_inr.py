...
class Trainer(TrainerTemplate):
    ...
    def get_accm(self):
        ...
        accm = AccmStageINR(
            scalar_metric_names=("loss_total", "mse", "psnr","onsurface_loss","spatial_loss","grad_loss","normal_loss","div_loss","bce_loss","off_surface_loss","pred_max","pred_min","weight_norm","grad_norm_mean"),
