...
class Trainer(TrainerTemplate):
    ...
    def get_accm(self):
        ...
        accm = AccmStageINR(
            scalar_metric_names=("loss_total", "mse", "psnr","onsurface_loss","spatial_loss","grad_loss","normal_loss","div_loss","bce_loss","off_surface_loss"),
    ...
    def eval(self, valid=True, ema=False, verbose=False, epoch=0):
        ...
        for it, xt in pbar:
           ...
           # targets = xs.detach()
            loss = model.compute_loss(outputs, xs,type=self.config.dataset.supervision,coords=coord_inputs,mode='sum')
